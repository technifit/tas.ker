...
function InputOTPSeparator({ ...props }: React.ComponentProps<"div">) {
  return (
    // biome-ignore lint/a11y/useFocusableInteractive: We don't want to focus on the separator
    // biome-ignore lint/a11y/useSemanticElements: We want to use a semantic element for the separator as we want to use the MinusIcon
