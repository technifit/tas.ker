...
function SidebarProvider({
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: We want to toggle the sidebar on mobile and desktop
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: We want to memoize the context value
